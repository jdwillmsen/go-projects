...
import (
	...
	"github.com/jdwillmsen/jwt-project/database"
	"github.com/jdwillmsen/jwt-project/helpers"
	"github.com/jdwillmsen/jwt-project/models"
	...
	return func(c *gin.Context) {
		...
		projectStage := bson.D{
			{"$project", bson.D{
				{"_id", 0},
				{"total_count", 1},
				{"user_items", bson.D{{"$slice", []interface{}{
					"$data",
					startIndex,
					recordPerPage,
				}}}},
